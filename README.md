...
Multi-stage image uses Node 26 Alpine and Next.js `output: 'standalone'`.
...
| `FRESH_COOLDOWN_MS` | `0` | Per-IP cooldown for `fresh=1` (no Upstash); `0` = no cooldown |
